...
import {AdminCadastroCategoriaComponent} from './admin-cadastro-categoria/admin-cadastro-categoria.component';
...
const rotas: Routes = [
  ...
  {path: 'login', component: LoginComponent, },
  {
    ...
    children: [
      ...
      {path: 'categorias/cadastrar', component: AdminCadastroCategoriaComponent},
...
@NgModule({
  declarations: [
    ...
    AdminCadastroCategoriaComponent,
